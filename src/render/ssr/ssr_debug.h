...
// composite a reflection buffer over a scene color buffer in place, using each
// reflection's premultiplied weight. handy for producing a final image to
// eyeball / diff. scene and refl are w*h; out may alias scene.

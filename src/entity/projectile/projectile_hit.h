...
// nearest valid hit (smallest t) via out, or 0 if nothing was struck.
...
// damage a flush hit deals, given how much speed the shot has left. damage
// falls off with speed and gets a crit bump above the kind's crit_speed.

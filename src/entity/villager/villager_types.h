...
// a villager has a tiny inventory of "emeralds" plus profession produce.
// we don't model real item stacks here, just enough to drive trading.
#define VILLAGER_WALLET_MAX        64

// schedule resolution: the day is divided into this many slots. 24 keeps
// the math readable (one slot ~= one in-game hour).

...
// render `frames` stereo frames into `out` (length frames*2, interleaved s16).
// advances every voice, applies attenuation/pan/occlusion, sums, soft-clips.
// returns the number of voices that contributed audio this block.

...
// seasons cycle over a configurable number of in-game days. each season
// nudges temperature, daylight length and how likely snow vs rain is.
...
// days_per_season controls the cycle length. day is the world day counter.
